...
export const bylineWithLink = () => [
  {
    bylines: [
      {
        author: {
          image: `${IMAGE_BASE_URL}/imageserver/image/methode%2Ftimes%2Fprodp%2Fweb%2Fbin%2Fc341435d-5352-4952-afa5-a232f17c79c2.jpg?crop=600%2C600%2C0%2C0&resize=200`,
    ...
    children: [
      ...
      },
      {
        attributes: {
          ...
          href: `${FIXTURES_ARTICLE_BASE_URL}/article/independent-group-change-uk-gets-approval-but-makes-a-hash-of-logo-hwm0bxsxn`,
          type: "article"
        },
        children: [
          {
  ...
  items: [
    ...
    },
    {
      article: {
        ...
        url: `${FIXTURES_ARTICLE_BASE_URL}/article/youtube-ignored-police-pleas-to-remove-threatening-videos-62v2mqp23`
      }
    }
  ],
...
export const contentWithItalicText = [
  {
    ...
    children: [
      ...
      },
      {
        name: "link",
        attributes: {
          href: `${FIXTURES_ARTICLE_BASE_URL}/article/what-next-for-james-bond-m0s5vjkxz`,
          type: "article",
