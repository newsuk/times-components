...
const newslettersBySection = [
  {
    ...
    payload: setNewsletterPayload({
      ...
      copy: "Our flagship newsletter featuring our top stories and analysis, delivered every morning.",
      imageUri:
  ...
  },
  {
    ...
    payload: setNewsletterPayload({
      ...
      copy: "Morning and midday updates on financial and economic news from our award-winning business team.",
      imageUri:
  ...
  },
  {
    ...
    payload: setNewsletterPayload({
      ...
      copy: "The biggest stories from The Times and Sunday Times Scotland, every Saturday.",
      imageUri:
  ...
  },
  {
    ...
    payload: setNewsletterPayload({
      ...
      copy: "Personal finance and investment news from our money experts, every Monday.",
      imageUri:
  ...
  },
  {
    ...
    payload: setNewsletterPayload({
      code: "TNL-121",
      headline: "The Brief",
      copy: "Get expert analysis, news and commentary in The Brief, our legal editor's insider's guide, every Thursday.",
      imageUri:
  ...
  },
  {
    ...
    payload: setNewsletterPayload({
      ...
      copy: "Inside Britain's most exclusive homes, expert advice and what's really happening in the property market, every Monday.",
      imageUri:
  ...
  },
  {
    ...
    payload: setNewsletterPayload({
      ...
      copy: "The most compelling Irish news, business, sport and lifestyle stories from the week, every Sunday."
    })
  },
  {
    section: "irish-sport",
