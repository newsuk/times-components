...
export default () => {
  ...
  const tests = [
    {
      name: "Render full article when user is logged in",
      test() {
    ...
    {
      name: "Render teaser article when user is not logged in",
      test() {
        const output = TestRenderer.create(
          renderArticle({ isLoggedIn: false })
        );
    ...
    {
      name: "Render teaser article when user is null",
      test() {
