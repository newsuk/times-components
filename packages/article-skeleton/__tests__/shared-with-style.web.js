...
import { renderArticle } from "./shared.base";
...
export default () => {
  ...
  it("passes a null save and share bar when both saving and sharing is not enabled", () => {
    const Header = () => null;
    ...
    expect(header.props.saveAndShareBar).toEqual(null);
  });

  it("passes the save and share bar when saving is enabled", () => {
    const Header = () => null;
    const testRenderer = TestRenderer.create(
      renderArticle(
        {
    ...
    const header = testRenderer.root.findByType(Header);
    const saveAndShareBar = TestRenderer.create(header.props.saveAndShareBar);
    expect(saveAndShareBar).toMatchSnapshot();
  });

  it("passes the save and share bar when sharing is enabled", () => {
    const Header = () => null;
    const testRenderer = TestRenderer.create(
      renderArticle(
        {
  ...
  it("passes the save and share bar when both saving & sharing are enabled", () => {
    const Header = () => null;
    const testRenderer = TestRenderer.create(
      renderArticle(
        {
