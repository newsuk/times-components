import { BASE_URL, FEEDS_BASE_URL, IMAGE_BASE_URL } from "../constants";
...
const defaultAuthor = {
  image:
    `${FEEDS_BASE_URL}/web/imageserver/imageserver/image/methode%2Ftimes%2Fprod%2Fweb%2Fbin%2F0694e84e-04ff-11e7-976a-0b4b9a1a67a3.jpg?crop=854,854,214,0&resize=400`
};
...
const defaultContent = [
        ...
        children: [
          {
            children: [
              {
                attributes: {
                  value: "Another ministerial aide, "
                },
                children: [],
                name: "text"
              },
              {
                attributes: {
                  href:
                    `${BASE_URL}/edition/news/may-hit-by-another-brexit-walkout-amid-claims-of-establishment-coup-k9x69qlb8`,
                  target: "_blank",
                  type: "article"
                },
                children: [
              ...
              },
              {
                attributes: {
                  value:
                    ", resigned saying that he could not look himself in the mirror if he backed the Chequers proposals."
                },
                children: [],
                name: "text"
              }
            ...
            children: [
              {
                attributes: {
                  value:
                    'Dennis Mitchell’s high levels of testosterone in 1998 were caused by having sex with his wife "at least four times" on her birthday, according to the sprinter. USA Track and Field believed him, the IAAF did not'
                },
                children: [],
                name: "text"
              }
          ...
          },
          {
            children: [
              {
                attributes: {
                  value: "Chuka Umunna, leader of the "
                },
                children: [],
                name: "text"
              },
              ...
              },
              {
                attributes: {
                  value:
                    " as “anti-worker and anti-business” and said that it would “royally screw” Britain’s service sector."
                },
                children: [],
                name: "text"
              }
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        attributes: {
          href:
            `${BASE_URL}/article/peers-call-for-action-after-liam-allan-trial-blunder-vnzn0sz89`
        },
        children: [
          {
            attributes: {
  ...
  },
  {
    attributes: {
      ...
      posterImageUrl:
        `${IMAGE_BASE_URL}/imageserver/image/%2Fmethode%2Ftimes%2Fprod%2Fweb%2Fbin%2F0c0309d4-1aeb-11e8-9010-1eef6ba5d3de.jpg?crop=1024%2C576%2C0%2C0`
    },
    children: [],
    name: "video"
  },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        attributes: {
          value:
            ". She toured the world, speaking for large fees in the foundation’s name and to its great financial benefit. She remained immensely popular in several countries, particularly the US, Japan and Eastern Europe. She was the symbol of the defeat of communism and the triumph in the 1980s of market economics. "
        },
        children: [],
        name: "text"
      }
  ...
  items: [
    ...
    },
    {
      article: {
        ...
        url:
          `${BASE_URL}/article/youtube-ignored-police-pleas-to-remove-threatening-videos-62v2mqp23`
      }
    }
  ]
};
...
const defaultUrl =
  `${BASE_URL}/edition/news/france-defies-may-over-russia-37b27qd2s`;
...
export default ({ withAds = true, ...config } = {}) => {
  ...
  const filteredContent = { ...defaultConfig };
