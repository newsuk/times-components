...
const TcText = styled.div`
  ...
  font-size: ${props =>
    props.style && props.style.fontSize ? props.style.fontSize : "14px"};
  font-weight: ${props =>
    props.style && props.style.fontWeight && props.style.fontWeight};
  margin-bottom: ${props =>
    props.style && props.style.marginBottom ? props.style.marginBottom : "0px"};
  margin-left: ${props =>
    props.style && props.style.marginLeft ? props.style.marginLeft : "0px"};
  margin-top: ${props =>
