...
## [0.4.8](https://github.com/newsuk/times-components/compare/@times-components/responsive-image@0.4.7...@times-components/responsive-image@0.4.8) (2020-01-22)
...
* util version ([#1626](https://github.com/newsuk/times-components/issues/1626)) ([a82777f](https://github.com/newsuk/times-components/commit/a82777f))
...
* various ios ([#2431](https://github.com/newsuk/times-components/issues/2431)) ([5699cb5](https://github.com/newsuk/times-components/commit/5699cb5))
...
* **depend:** add missing param for --only ([#1160](https://github.com/newsuk/times-components/issues/1160)) ([f15d4b0](https://github.com/newsuk/times-components/commit/f15d4b0))
* **REPLAT-10511:** tabbing issue in share and save bar ([#2442](https://github.com/newsuk/times-components/issues/2442)) ([6875b57](https://github.com/newsuk/times-components/commit/6875b57))
* **REPLAT-11035:** fix layout issue with inline image and article-extra ([#2446](https://github.com/newsuk/times-components/issues/2446)) ([eab36fe](https://github.com/newsuk/times-components/commit/eab36fe))
...
* **REPLAT-11036:** Wrap sponsored article div to fix issue with commenting ([#2436](https://github.com/newsuk/times-components/issues/2436)) ([a37229c](https://github.com/newsuk/times-components/commit/a37229c))
* **REPLAT-11399:** fix bylines that were breaking out of container ([#2449](https://github.com/newsuk/times-components/issues/2449)) ([8206ed0](https://github.com/newsuk/times-components/commit/8206ed0))


### Build System

* .gitignore the ios/Index folder ([#1381](https://github.com/newsuk/times-components/issues/1381)) ([0002621](https://github.com/newsuk/times-components/commit/0002621))
* upgrade yarn ([#1361](https://github.com/newsuk/times-components/issues/1361)) ([750b58e](https://github.com/newsuk/times-components/commit/750b58e))
...
* (replat 7163) fix issues from design review ([#2140](https://github.com/newsuk/times-components/issues/2140)) ([5ad3715](https://github.com/newsuk/times-components/commit/5ad3715))
...
* add article id to aid debugging and testing ([#2364](https://github.com/newsuk/times-components/issues/2364)) ([02c4572](https://github.com/newsuk/times-components/commit/02c4572))
* add article image lazy loading ([#2385](https://github.com/newsuk/times-components/issues/2385)) ([98604cd](https://github.com/newsuk/times-components/commit/98604cd))
...
* add basic implementation for ads ([#2434](https://github.com/newsuk/times-components/issues/2434)) ([6089276](https://github.com/newsuk/times-components/commit/6089276))
...
* add customMPU ad slot ([#2344](https://github.com/newsuk/times-components/issues/2344)) ([e29454e](https://github.com/newsuk/times-components/commit/e29454e))
...
* add tracking to comments and article-link text to tracking REPLAT-7189 ([#2200](https://github.com/newsuk/times-components/issues/2200)) ([c186ce3](https://github.com/newsuk/times-components/commit/c186ce3))
...
* added README and tests to CLI ([#1094](https://github.com/newsuk/times-components/issues/1094)) ([1b635f9](https://github.com/newsuk/times-components/commit/1b635f9))
...
* analytics react article registration type ([#2019](https://github.com/newsuk/times-components/issues/2019)) ([141b10b](https://github.com/newsuk/times-components/commit/141b10b))
* Article cypress tests ([#1599](https://github.com/newsuk/times-components/issues/1599)) ([11d73c9](https://github.com/newsuk/times-components/commit/11d73c9))
...
* Byline links ([#998](https://github.com/newsuk/times-components/issues/998)) ([5ad2745](https://github.com/newsuk/times-components/commit/5ad2745))
...
* Comments template ([#1493](https://github.com/newsuk/times-components/issues/1493)) ([a09f731](https://github.com/newsuk/times-components/commit/a09f731))
...
* design changes for ios release ([#2392](https://github.com/newsuk/times-components/issues/2392)) ([a9ccbe3](https://github.com/newsuk/times-components/commit/a9ccbe3))
...
* Display metered expired page for metered expired users ([#1970](https://github.com/newsuk/times-components/issues/1970)) ([c82a389](https://github.com/newsuk/times-components/commit/c82a389))
...
* edition checker ([#1682](https://github.com/newsuk/times-components/issues/1682)) ([100b79a](https://github.com/newsuk/times-components/commit/100b79a))
...
* integrate new bylines ([#1610](https://github.com/newsuk/times-components/issues/1610)) ([d84d301](https://github.com/newsuk/times-components/commit/d84d301))
...
* Interactive Wrapper ([#1288](https://github.com/newsuk/times-components/issues/1288)) ([f7577d8](https://github.com/newsuk/times-components/commit/f7577d8))
...
* magazine comment template ([#1519](https://github.com/newsuk/times-components/issues/1519)) ([8a35dda](https://github.com/newsuk/times-components/commit/8a35dda))
...
* migrate master pipeline to circleci ([#2440](https://github.com/newsuk/times-components/issues/2440)) ([19786b5](https://github.com/newsuk/times-components/commit/19786b5))
...
* more design changes ([#2403](https://github.com/newsuk/times-components/issues/2403)) ([4bffbb2](https://github.com/newsuk/times-components/commit/4bffbb2))
...
* replace byline with bylines ([#1771](https://github.com/newsuk/times-components/issues/1771)) ([8a7a74e](https://github.com/newsuk/times-components/commit/8a7a74e))
...
* Replace Grapeshot with ADmantx ([#2274](https://github.com/newsuk/times-components/issues/2274)) ([5327405](https://github.com/newsuk/times-components/commit/5327405))
...
* REPLAT-10475 draft article query and provider created ([#2387](https://github.com/newsuk/times-components/issues/2387)) ([5af75e4](https://github.com/newsuk/times-components/commit/5af75e4))
* REPLAT-11397 drop cap starting with quote for web ([#2451](https://github.com/newsuk/times-components/issues/2451)) ([b0b3d34](https://github.com/newsuk/times-components/commit/b0b3d34))
...
* REPLAT-4828 Update colours in In Depth article ([#1597](https://github.com/newsuk/times-components/issues/1597)) ([9b2015c](https://github.com/newsuk/times-components/commit/9b2015c))
...
* REPLAT-5155 In depth header width ([#1629](https://github.com/newsuk/times-components/issues/1629)) ([e62ec87](https://github.com/newsuk/times-components/commit/e62ec87))
...
* REPLAT-6900 article main standart design amends ([#2087](https://github.com/newsuk/times-components/issues/2087)) ([0d0a9fc](https://github.com/newsuk/times-components/commit/0d0a9fc))
...
* REPLAT-9476 metadata fix ([#2386](https://github.com/newsuk/times-components/issues/2386)) ([387685f](https://github.com/newsuk/times-components/commit/387685f))
...
* section colouring of components from tiles ([#2368](https://github.com/newsuk/times-components/issues/2368)) ([22f4a70](https://github.com/newsuk/times-components/commit/22f4a70))
...
* Slice layout refactor - Using Column ([#1766](https://github.com/newsuk/times-components/issues/1766)) ([2586803](https://github.com/newsuk/times-components/commit/2586803))
* slices 1024px ([#2241](https://github.com/newsuk/times-components/issues/2241)) ([f2bbaf7](https://github.com/newsuk/times-components/commit/f2bbaf7)), closes [#2191](https://github.com/newsuk/times-components/issues/2191) [#2189](https://github.com/newsuk/times-components/issues/2189) [#2199](https://github.com/newsuk/times-components/issues/2199) [#2193](https://github.com/newsuk/times-components/issues/2193) [#2195](https://github.com/newsuk/times-components/issues/2195) [#2196](https://github.com/newsuk/times-components/issues/2196) [#2191](https://github.com/newsuk/times-components/issues/2191) [#2189](https://github.com/newsuk/times-components/issues/2189) [#2209](https://github.com/newsuk/times-components/issues/2209) [#2206](https://github.com/newsuk/times-components/issues/2206) [#2204](https://github.com/newsuk/times-components/issues/2204) [#2208](https://github.com/newsuk/times-components/issues/2208) [#2213](https://github.com/newsuk/times-components/issues/2213) [#2213](https://github.com/newsuk/times-components/issues/2213) [#2214](https://github.com/newsuk/times-components/issues/2214) [#2219](https://github.com/newsuk/times-components/issues/2219) [#2218](https://github.com/newsuk/times-components/issues/2218) [#2225](https://github.com/newsuk/times-components/issues/2225) [#2212](https://github.com/newsuk/times-components/issues/2212) [#2234](https://github.com/newsuk/times-components/issues/2234) [#2193](https://github.com/newsuk/times-components/issues/2193) [#2195](https://github.com/newsuk/times-components/issues/2195) [#2196](https://github.com/newsuk/times-components/issues/2196) [#2198](https://github.com/newsuk/times-components/issues/2198) [#2201](https://github.com/newsuk/times-components/issues/2201) [#2207](https://github.com/newsuk/times-components/issues/2207) [#2200](https://github.com/newsuk/times-components/issues/2200) [#2190](https://github.com/newsuk/times-components/issues/2190) [#2197](https://github.com/newsuk/times-components/issues/2197) [#2186](https://github.com/newsuk/times-components/issues/2186) [#2205](https://github.com/newsuk/times-components/issues/2205) [#2215](https://github.com/newsuk/times-components/issues/2215) [#2220](https://github.com/newsuk/times-components/issues/2220) [#2194](https://github.com/newsuk/times-components/issues/2194) [#2216](https://github.com/newsuk/times-components/issues/2216) [#2223](https://github.com/newsuk/times-components/issues/2223) [#2226](https://github.com/newsuk/times-components/issues/2226) [#2222](https://github.com/newsuk/times-components/issues/2222) [#2217](https://github.com/newsuk/times-components/issues/2217) [#2237](https://github.com/newsuk/times-components/issues/2237) [#2230](https://github.com/newsuk/times-components/issues/2230) [#2239](https://github.com/newsuk/times-components/issues/2239) [#2229](https://github.com/newsuk/times-components/issues/2229) [#2240](https://github.com/newsuk/times-components/issues/2240)
...
* standard slice ([#1829](https://github.com/newsuk/times-components/issues/1829)) ([c6e6904](https://github.com/newsuk/times-components/commit/c6e6904))
...
* Updated video icon ([#1761](https://github.com/newsuk/times-components/issues/1761)) ([df51e7d](https://github.com/newsuk/times-components/commit/df51e7d))
...
* add jest lint config to watermark ([#1136](https://github.com/newsuk/times-components/issues/1136)) ([98e2635](https://github.com/newsuk/times-components/commit/98e2635))
* add schema tests ([#1282](https://github.com/newsuk/times-components/issues/1282)) ([18004fe](https://github.com/newsuk/times-components/commit/18004fe))
* article byline ([#1047](https://github.com/newsuk/times-components/issues/1047)) ([e0f464e](https://github.com/newsuk/times-components/commit/e0f464e))
* article main tests ([#1480](https://github.com/newsuk/times-components/issues/1480)) ([12da488](https://github.com/newsuk/times-components/commit/12da488))
* bump jest ([#1130](https://github.com/newsuk/times-components/issues/1130)) ([c4c29d6](https://github.com/newsuk/times-components/commit/c4c29d6))
* fix enzyme snaps ([#1163](https://github.com/newsuk/times-components/issues/1163)) ([2f45bfb](https://github.com/newsuk/times-components/commit/2f45bfb))
* getHeadline test added to utils package ([#1501](https://github.com/newsuk/times-components/issues/1501)) ([25fdb13](https://github.com/newsuk/times-components/commit/25fdb13))
* improve snapshots of watermark ([#1096](https://github.com/newsuk/times-components/issues/1096)) ([ba6332f](https://github.com/newsuk/times-components/commit/ba6332f))
* improve video label snapshots ([#1097](https://github.com/newsuk/times-components/issues/1097)) ([61db7ad](https://github.com/newsuk/times-components/commit/61db7ad))
* improve video snapshots ([#1107](https://github.com/newsuk/times-components/issues/1107)) ([1ae9478](https://github.com/newsuk/times-components/commit/1ae9478))
* improve video snapshots ([#1137](https://github.com/newsuk/times-components/issues/1137)) ([93a1a92](https://github.com/newsuk/times-components/commit/93a1a92))
* make article flag pass linting ([#1043](https://github.com/newsuk/times-components/issues/1043)) ([5958ae7](https://github.com/newsuk/times-components/commit/5958ae7))
* mock ads in article-list tests ([#1215](https://github.com/newsuk/times-components/issues/1215)) ([e4d6738](https://github.com/newsuk/times-components/commit/e4d6738))
* move to JC ([#1019](https://github.com/newsuk/times-components/issues/1019)) ([aa515e2](https://github.com/newsuk/times-components/commit/aa515e2))
* prepare tests for Jest bump ([#1127](https://github.com/newsuk/times-components/issues/1127)) ([bb5226b](https://github.com/newsuk/times-components/commit/bb5226b))
* refactor article summary ([#1065](https://github.com/newsuk/times-components/issues/1065)) ([c0c777b](https://github.com/newsuk/times-components/commit/c0c777b))
* refactor article testing ([#1128](https://github.com/newsuk/times-components/issues/1128)) ([37ac843](https://github.com/newsuk/times-components/commit/37ac843))
* refactor author profile snaps ([#1161](https://github.com/newsuk/times-components/issues/1161)) ([2f813c3](https://github.com/newsuk/times-components/commit/2f813c3))
* refactor button snaps ([#1067](https://github.com/newsuk/times-components/issues/1067)) ([776ddd4](https://github.com/newsuk/times-components/commit/776ddd4))
* refactor caption ([#1072](https://github.com/newsuk/times-components/issues/1072)) ([1bb5a08](https://github.com/newsuk/times-components/commit/1bb5a08))
* refactor card snapshots ([#1075](https://github.com/newsuk/times-components/issues/1075)) ([6f16200](https://github.com/newsuk/times-components/commit/6f16200))
* refactor icon snaps ([#1081](https://github.com/newsuk/times-components/issues/1081)) ([3c3f0ac](https://github.com/newsuk/times-components/commit/3c3f0ac))
* refactor markup snaps ([#1085](https://github.com/newsuk/times-components/issues/1085)) ([8b57285](https://github.com/newsuk/times-components/commit/8b57285))
* refactor pagination snaps ([#1091](https://github.com/newsuk/times-components/issues/1091)) ([3d40a95](https://github.com/newsuk/times-components/commit/3d40a95))
* refactor pull quote ([#1121](https://github.com/newsuk/times-components/issues/1121)) ([e8e606f](https://github.com/newsuk/times-components/commit/e8e606f))
* refactor related article snaps ([#1112](https://github.com/newsuk/times-components/issues/1112)) ([354b4c4](https://github.com/newsuk/times-components/commit/354b4c4))
* refactor slice snaps ([#1113](https://github.com/newsuk/times-components/issues/1113)) ([fe84769](https://github.com/newsuk/times-components/commit/fe84769))
* refactor snaps ([#1134](https://github.com/newsuk/times-components/issues/1134)) ([790dabc](https://github.com/newsuk/times-components/commit/790dabc))
* refactor styleguide snaps ([#1114](https://github.com/newsuk/times-components/issues/1114)) ([5d5a2a1](https://github.com/newsuk/times-components/commit/5d5a2a1))
* refactor svg snaps ([#1115](https://github.com/newsuk/times-components/issues/1115)) ([630af96](https://github.com/newsuk/times-components/commit/630af96))
* refactor web and native tests to pass linting ([#1056](https://github.com/newsuk/times-components/issues/1056)) ([e78e8eb](https://github.com/newsuk/times-components/commit/e78e8eb))
* remove prop type warnings in article ([#1415](https://github.com/newsuk/times-components/issues/1415)) ([9dc5098](https://github.com/newsuk/times-components/commit/9dc5098))
...
## [0.1.16](https://github.com/newsuk/times-components/compare/@times-components/responsive-image@0.1.15...@times-components/responsive-image@0.1.16) (2019-12-18)
...
## [0.1.13](https://github.com/newsuk/times-components/compare/@times-components/responsive-image@0.1.12...@times-components/responsive-image@0.1.13) (2019-12-10)
...
## [0.1.12](https://github.com/newsuk/times-components/compare/@times-components/responsive-image@0.1.11...@times-components/responsive-image@0.1.12) (2019-12-10)
...
## [0.1.11](https://github.com/newsuk/times-components/compare/@times-components/responsive-image@0.1.10...@times-components/responsive-image@0.1.11) (2019-12-09)
...
## [0.1.8](https://github.com/newsuk/times-components/compare/@times-components/responsive-image@0.1.7...@times-components/responsive-image@0.1.8) (2019-12-05)
...
## [0.1.5](https://github.com/newsuk/times-components/compare/@times-components/responsive-image@0.1.4...@times-components/responsive-image@0.1.5) (2019-12-04)
...
## [0.1.4](https://github.com/newsuk/times-components/compare/@times-components/responsive-image@0.1.3...@times-components/responsive-image@0.1.4) (2019-11-30)
...
# [0.1.0](https://github.com/newsuk/times-components/compare/@times-components/responsive-image@0.0.5...@times-components/responsive-image@0.1.0) (2019-11-21)
...
## [0.0.5](https://github.com/newsuk/times-components/compare/@times-components/responsive-image@0.0.4...@times-components/responsive-image@0.0.5) (2019-11-19)
...
## [0.0.4](https://github.com/newsuk/times-components/compare/@times-components/responsive-image@0.0.3...@times-components/responsive-image@0.0.4) (2019-11-14)


### Bug Fixes

* the watch command ([#2384](https://github.com/newsuk/times-components/issues/2384)) ([3a9e9a3](https://github.com/newsuk/times-components/commit/3a9e9a3caed007aba2d9f981abe72efd1e513d05))





## [0.0.3](https://github.com/newsuk/times-components/compare/@times-components/responsive-image@0.0.2...@times-components/responsive-image@0.0.3) (2019-11-13)
