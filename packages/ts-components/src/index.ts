...
export { OptaFootballFixturesTournament } from './components/opta/football/fixtures-tournament/OptaFootballFixturesTournament';
...
export { OptaFootballMatchStats } from './components/opta/football/match-stats/OptaFootballMatchStats';
export { OptaFootballPlayerStats } from './components/opta/football/player-stats/OptaFootballPlayerStats';

export { OptaRugbyFixtures } from './components/opta/rugby/fixtures/OptaRugbyFixtures';
export { OptaRugbyStandings } from './components/opta/rugby/standings/OptaRugbyStandings';
export { OptaRugbySummary } from './components/opta/rugby/summary/OptaRugbySummary';
export { OptaRugbyMatchStats } from './components/opta/rugby/match-stats/OptaRugbyMatchStats';

// Related Article Components
export { RecommendedFetch } from './components/recommended-articles/RecommendedFetch';
export { CategorisedArticles } from './components/categorised-articles/CategorisedArticles';
