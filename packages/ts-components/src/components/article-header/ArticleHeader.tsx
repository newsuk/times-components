...
import { Container, Divider, Headline, TimeSincePublishing, TimeSincePublishingContainer, UpdatedDate, UpdatedTime, UpdatedTimeItems, UpdatesContainer } from './styles';
...
export const ArticleHeader: React.FC<{ updated: string; breaking: boolean, headline: string}> = ( { updated, breaking, headline }) => {
    ...
    const hoursDifference = differenceInHours(currentDateTime,updated);const isBreaking = Boolean(breaking);
