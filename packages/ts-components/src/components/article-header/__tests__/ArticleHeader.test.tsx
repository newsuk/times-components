...
describe('ArticleHeader', () => {
  ...
  describe('Article header byline', () => {
    ...
    const authorData = {
      slug: 'oliver-wright',
      name: 'Oliver Wright',
      image: `${IMAGE_BASE_URL}/imageserver/image/methode%2Ftimes%2Fstag%2Fweb%2Fbin%2Fe1ca81d9-5ef0-442e-9493-8d9705bd9d03.jpg?crop=270%2C270%2C0%2C0&resize=200`,
