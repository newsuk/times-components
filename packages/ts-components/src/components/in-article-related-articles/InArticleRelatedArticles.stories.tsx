...
const article2 = {
  ...
  link:
    `${BASE_URL}/article/chinas-villages-trampled-in-elephant-herds-long-march-kvl8m8spx`,
  image:
...
const article3 = {
  ...
  link:
    `${BASE_URL}/article/the-times-view-on-elephants-suction-technique-talented-trunks-h3ck3zx6g`,
  image:
    `${IMAGE_BASE_URL}/imageserver/image/methode%2Ftimes%2Fprod%2Fweb%2Fbin%2Ff1a0847a-c3ea-11eb-a26e-4c086490cfe1.jpg?crop=4418%2C2945%2C0%2C0&resize=685`
};
