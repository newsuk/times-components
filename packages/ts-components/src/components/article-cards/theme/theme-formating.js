const modifyBaseRemValue = (multiplier, valueToUpdate) => {
...
export const updateThemeTypography = (themeObj) => {
...
export const addOverride = (updatedThemeObj, themeOverrides) => {
...
export const formatThemeOverrides = (themeObj, themeOverrides) => {
  const breakpoints = {
    xs: 0,
    sm: 520,
    md: 768,
