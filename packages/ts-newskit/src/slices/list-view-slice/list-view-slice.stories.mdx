...
export const ListViewSliceStory = ({ leadArticles, theme, gridOverlay, clickHandler, articleWithAdSlot, currentPage, itemsPerPage, isLoading, handlePageChange, StickyAd, SectionAd }) => (
  <TCThemeProvider theme={theme}>
    <>
      <GridOverlay show={gridOverlay} />
      <ListViewSlice {...{ leadArticles, clickHandler, articleWithAdSlot, currentPage, itemsPerPage, isLoading, handlePageChange, StickyAd, SectionAd }} />
    </>
  </TCThemeProvider>
);
