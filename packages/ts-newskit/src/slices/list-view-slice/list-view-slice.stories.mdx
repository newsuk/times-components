...
export const ListViewSliceStory = ({ leadArticles, theme, gridOverlay, clickHandler, articleWithAdSlot, currentPage, setCurrentPage }) => (
  <TCThemeProvider theme={theme}>
    <>
      <GridOverlay show={gridOverlay} />
      <ListViewSlice {...{ leadArticles, clickHandler, articleWithAdSlot, currentPage, setCurrentPage }} />
    </>
  </TCThemeProvider>
);
