...
import { leadArticle } from './data.json';
...
export const ListViewSliceStory = ({ leadArticle, theme, gridOverlay, clickHandler }) => (
  <TCThemeProvider theme={theme}>
    <>
      <GridOverlay show={gridOverlay} />
      <ListViewSlice {...{ leadArticle, clickHandler }} />
    </>
  </TCThemeProvider>
);
