...
export const HeaderStory = ({headline, color, readingTime, summary, bylines, subHeadline, caption, image, url, articleType, hasTagOrTimeToRead, imageTop}) => (
  <NewsKitProvider theme={TimesWebLightTheme}>
    <LeadStory {...{headline, color, readingTime, summary, bylines, subHeadline, caption, image, url, articleType, hasTagOrTimeToRead, imageTop}} />
  </NewsKitProvider>
);
