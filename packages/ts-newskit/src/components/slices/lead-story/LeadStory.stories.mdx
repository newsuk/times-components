...
import { headline,color,readingTime,summary,bylines,interviewee,caption,image,url } from '../fixture/data.json';

<Meta
  title="Newskit/Slices/LeadStory"
  component={LeadStory}
/>
...
## Code Example
`<LeadStory data={{headline, color, readingTime, summary, bylines, interviewee, caption, image, url}}/>`
...
export const HeaderStory = ({headline, color, readingTime, summary, bylines, interviewee, caption, image, url}) => (
  <NewsKitProvider theme={TimesWebLightTheme}>
    <LeadStory {...{headline, color, readingTime, summary, bylines, interviewee, caption, image, url}} />
  </NewsKitProvider>
);

<Story name="LeadStory"
   args={{headline, color, readingTime, summary, bylines, interviewee, caption, image, url}}>
  {HeaderStory.bind({})}
</Story>