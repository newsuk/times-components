...
describe('Render Component one', () => {
  ...
  it('should select image with correct ratio when loadingAspectRatio matches', () => {
    ...
    expect(imageElement.src).toBe(
      `${IMAGE_BASE_URL}/imageserver/image/%2Fmethode%2Ftimes%2Fprod%2Fweb%2Fbin%2Fbde50bea-247f-11ee-8c1b-d5d52b458fbd.jpg?crop=3844%2C2563%2C188%2C173&resize=750`
    );
  });

  it('should fall back to 3:2 ratio when loadingAspectRatio does not match any crop', () => {
    const loadingAspectRatio = '4:6';
  ...
  it('should fall back to 3:2 ratio when loadingAspectRatio does not provided', () => {
