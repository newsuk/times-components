...
export const GroupedArticleStory = ({tagL1 , articles, clickHandler}) => (
  <NewsKitProvider theme={TimesWebLightTheme}>
    <GroupedArticle {...{ tagL1 , articles, clickHandler}} />
  </NewsKitProvider>
);
...
<Story name="GroupedArticle" args={{ 
  ...
  articles:[
  {
    ...
    "shortSummary": "Short paragraph description of the article, outlining main story and focus.",
