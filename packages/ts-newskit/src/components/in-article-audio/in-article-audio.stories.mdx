...
<Meta
  title="Newskit Components/InArticleAudio"
...
export const InArticleAudioStory = ({ src, readyToPlayText, playingText, narrator, headline }) => (
  <TCThemeProvider>
    <InArticleAudio {...{ src, readyToPlayText, playingText, narrator, headline }} />
  </TCThemeProvider>
);
