...
- `id` (number): The ID of the puzzle.
- `shortIdentifier` (string): The short identifier of the puzzle.
- `title` (string): The title of the puzzle.
- `publishedAt` (string): The publish date of the puzzle.
- `status` (string): The status of the puzzle.
- `url` (string): The URL of the puzzle.
- `image` (object): The image object that contains the source and caption.
