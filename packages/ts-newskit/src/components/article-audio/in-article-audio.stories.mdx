...
export const InArticleAudioStory = ({ src, readyToPlayText, playingText, narrator, headline, feedback, showAudioPlayer }) => (
  <TCThemeProvider theme={TimesWebLightTheme}>
    <InArticleAudio {...{ src, readyToPlayText, playingText, narrator, headline, feedback, showAudioPlayer }} />
  </TCThemeProvider>
);
