...
describe("Prebid Config test", () => {
  ...
  it("should return the correct value for the hd_bidder", () => {
    const hbBidder = adserverTargeting.filter(item => item.key === 'hb_bidder')[0];
