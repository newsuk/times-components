...
const storeURL = {
  gb:
    `${STORE_URL_GB}?ILC=GB-TNL_The_Times-Conversion_Page-Homepage-2020`,
  ie:
    `${STORE_URL_IE}?ILC=IE-TNL_The_Times-Conversion_Page-Homepage-2020`,
  global:
    `${STORE_URL_GLOBAL}?ILC=INTL-TNL_The_Times-Conversion_Page-Homepage-2020`
};
