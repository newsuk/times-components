...
export default Component => {
  ...
  const tests = [
    ...
    {
      name: "main standard template - single inline element",
      test: () => {
    ...
    {
      name: "main standard template - with the author in the beginning",
      test: () => {
        const testInstance = renderArticleBylineMainStandard({
          ast: authorsFixture.authorInTheBeginning
        });
    ...
    {
      name: "main standard template - with the author at the end",
      test: () => {
        const testInstance = renderArticleBylineMainStandard({
          ast: authorsFixture.authorAtTheEnd
        });
    ...
    {
      name:
        "main standard template - with multiple authors separated by a pipe, parsed and replaced with commas",
      test: () => {
        const testInstance = renderArticleBylineMainStandard({
          ast: authorsFixture.multipleAuthorsPipeSeparated
        });
    ...
    {
      name:
        "main standard template - with multiple authors separated by text with commas",
      test: () => {
        const testInstance = renderArticleBylineMainStandard({
          ast: authorsFixture.multipleAuthorsCommaSeparated
        });
    ...
    {
      name:
        "main standard template - with multiple authors separated by spaces",
      test: () => {
        const testInstance = renderArticleBylineMainStandard({
          ast: authorsFixture.multipleAuthorsSpaceSeparated
        });
