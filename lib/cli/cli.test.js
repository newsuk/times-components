...
describe("./times-components CLI interface", () => {
  ...
  describe("creates a package", () => {
    it("with a pretty index file", () => {
      expect(prettier.check(read("src/test-component-delete-me.js"))).toEqual(true);
    });
    ...
    it("with a pretty ios test file", () => {
      expect(
        prettier.check(read("src/__tests__/ios/test-component-delete-me.test.js"))
      ).toEqual(true);
    });

    it("with a pretty web test file", () => {
      expect(
        prettier.check(read("src/__tests__/web/test-component-delete-me.test.js"))
      ).toEqual(true);
    });
