...
const storyFile = handlebars.compile(`import { showcaseConverter } from "@times-components-native/storybook";
...
const jestConfigFile = platform =>
  handlebars.compile(`const jestConfigurator = require("@times-components-native/jest-configurator").default;
