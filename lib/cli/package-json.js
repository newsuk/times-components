module.exports = variables => ({
  ...
  devDependencies: {
    "@times-components-native/eslint-config-thetimes": "*",
    "@times-components-native/jest-configurator": "*",
    "@times-components-native/jest-serializer": "*",
    "@times-components-native/storybook": "*",
    "@times-components-native/test-utils": "*",
    "@times-components-native/webpack-configurator": "*",
    "@babel/core": "7.4.4",
    "babel-jest": "24.8.0",
    "babel-loader": "8.0.5",
    eslint: "4.19.1",
