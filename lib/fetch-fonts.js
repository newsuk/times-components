...
const fonts = [
  ...
  },
  {
    ...
    sources: [
      `${fontCdn}/Flama/FlamaBold-webfont.woff2`,
      `${fontCdn}/Flama/FlamaBold-webfont.woff`,
      `${fontCdn}/Flama/FlamaBold-webfont.ttf`
    ]
  },
  {
      ...
      sources.map(source => {
        ...
        if (!fs.existsSync(dest)) {
          return download(source, dest).then(
            () =>
              extension === ".ttf" ? generate(dest, fontName, fontFamily) : null
          );
        }
